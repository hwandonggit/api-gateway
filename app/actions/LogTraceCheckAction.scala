...
/** Action to check json parameters .
  ...
  */
class LogTraceCheckAction @Inject()(val parser: BodyParsers.Default,
                                    logger: LogWriter,
                                    config: Configuration)
                                   (implicit ec: ExecutionContext)
  extends ActionFilter[LogTraceRequest] {
  ...
  /** filter component
    ...
    * @return
    */
  override def filter[A](request: LogTraceRequest[A]) = Future.successful {
    request.trace match {
