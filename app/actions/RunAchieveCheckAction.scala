...
/** Action to check json parameters .
  ...
  */
class RunAchieveCheckAction @Inject()(val parser: BodyParsers.Default,
                                      logger: LogWriter,
                                      config: Configuration)
                                     (implicit ec: ExecutionContext)
  extends ActionFilter[AchieveRequest] {
  ...
  /** filter component
    ...
    * @return
    */
  override def filter[A](request: AchieveRequest[A]) = Future.successful {
    request.run match {
